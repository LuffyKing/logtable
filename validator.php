      ...
      case 'password':
        if (strlen($value) < 8) {
          $errors['password'] = 'Invalid Password. Password input must be at least 8 characters';
            ...
            $errors['password'] = 'Invalid Password. Password input must be at less than or equals to 50 characters';
        }
        elseif (preg_match("/[^a-zA-Z0-9_!]/", $value)){
          $errors['password'] =  'Invalid Password. Password input can only contain alphanumneric characters, _ and !';
        }
        break;
      case 'text':
        if (strlen($value) < 10) {
